#
# STEMI: receipt of all secondary prevention medication: Key models 
#
# K. Fleetwood
# 13 Feb 2025
...
outcome_folder <- file.path(ccu046_01_folder, "processed_data_stemi_prev")
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "25a_care_stemi_prev_mod1to5.csv")
)
write.csv(
  anova_1to5, 
  file.path(outcome_folder, "25a_care_stemi_prev_anova1to5.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "25a_care_stemi_prev_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "25a_care_stemi_prev_anova_int.csv")
) 
