#
# STEMI: door to balloon withing 60 minutes: Key models 
#
# K. Fleetwood
# 18 Feb 2025: Adapted from 20c
#
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "22a_care_stemi_dtb60_mod1to5.csv")
)
write.csv(
  anova_1to5, 
  file.path(outcome_folder, "22a_care_stemi_dtb60_anova1to5.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "22a_care_stemi_dtb60_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "22a_care_stemi_dtb60_anova_int.csv")
) 
