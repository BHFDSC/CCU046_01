#
# STEMI: door to balloon within 90 minutes: Key models 
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "23b_care_stemi_dtb90_mod1to4.csv")
)
write.csv(
  anova_1to4, 
  file.path(outcome_folder, "23b_care_stemi_dtb90_anova1to4.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "23b_care_stemi_dtb90_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "23b_care_stemi_dtb90_anova_int.csv")
) 
