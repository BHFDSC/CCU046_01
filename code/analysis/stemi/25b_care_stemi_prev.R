...
outcome_folder <- file.path(ccu046_01_folder, "processed_data_stemi_rehab")
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "25b_care_stemi_prev_mod1to4.csv")
)
write.csv(
  anova_1to4, 
  file.path(outcome_folder, "25b_care_stemi_prev_anova1to4.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "25b_care_stemi_prev_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "25b_care_stemi_prev_anova_int.csv")
) 
