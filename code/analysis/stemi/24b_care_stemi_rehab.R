#
# STEMI: cardiac rehabilitation: Key models 
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "24b_care_stemi_rehab_mod1to4.csv")
)
write.csv(
  anova_1to4, 
  file.path(outcome_folder, "24b_care_stemi_rehab_anova1to4.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "24b_care_stemi_rehab_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "24b_care_stemi_rehab_anova_int.csv")
) 
