...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "13c_care_nstemi_ward_mod1to5.csv")
)
write.csv(
  anova_1to5, 
  file.path(outcome_folder, "13c_care_nstemi_ward_anova1to5.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "13c_care_nstemi_ward_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "13c_care_nstemi_ward_anova_int.csv")
) 
