...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "14a_care_nstemi_rehab_mod1to5.csv")
)
write.csv(
  anova_1to5, 
  file.path(outcome_folder, "14a_care_nstemi_rehab_anova1to5.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "14a_care_nstemi_rehab_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "14a_care_nstemi_rehab_anova_int.csv")
) 
